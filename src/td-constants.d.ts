...
export declare const QOS: Readonly<{
    express: 0;
    realtime: 1;
    fast: 2;
    moderate: 3;
...
export declare const ACCT_ACTIVITY: Readonly<{
    subscriptionKey: 0;
    accountNumber: 1;
    messageType: 2;
    messageData: 3;
}>;
export declare const CHART_EQUITY: Readonly<{
    key: 0;
    openPrice: 1;
    highPrice: 2;
    lowPrice: 3;
...
export declare const CHART_FUTURES: Readonly<{
    key: 0;
    chartTime: 1;
    openPrice: 2;
    highPrice: 3;
...
export declare const CHART_OPTIONS: Readonly<{
    key: 0;
    chartTime: 1;
    openPrice: 2;
    highPrice: 3;
...
export declare const NEWS_HEADLINE: Readonly<{
    symbol: 0;
    errorCode: 1;
    storyDatetime: 2;
    headlineId: 3;
...
export declare const TIMESALE: Readonly<{
    symbol: 0;
    tradeTime: 1;
    lastPrice: 2;
    lastSize: 3;
...
export declare const LEVEL_ONE_EQUITY: Readonly<{
    symbol: 0;
    bidPrice: 1;
    askPrice: 2;
    lastPrice: 3;
...
export declare const LEVEL_ONE_FUTURES: Readonly<{
    symbol: 0;
    bidPrice: 1;
    askPrice: 2;
    lastPrice: 3;
...
export declare const LEVEL_ONE_OPTION: Readonly<{
    symbol: 0;
    description: 1;
    bidPrice: 2;
    askPrice: 3;
...
export declare const LISTED_BOOK: Readonly<{
    symbol: 0;
    bookTime: 1;
    bids: 2;
    asks: 3;
}>;
export declare const NASDAQ_BOOK: Readonly<{
    symbol: 0;
    bookTime: 1;
    bids: 2;
    asks: 3;
}>;
export declare const OPTIONS_BOOK: Readonly<{
    symbol: 0;
    bookTime: 1;
    bids: 2;
    asks: 3;
}>;
export declare const BID_FIELDS: Readonly<{
    price: 0;
    totalVolume: 1;
    numBids: 2;
    bids: 3;
}>;
export declare const ASK_FIELDS: Readonly<{
    price: 0;
    totalVolume: 1;
    numAsks: 2;
    asks: 3;
}>;
export declare const ORDER_BOOK_EXCHANGE_FIELDS: Readonly<{
    exchange: 0;
    volume: 1;
    sequence: 2;
}>;
