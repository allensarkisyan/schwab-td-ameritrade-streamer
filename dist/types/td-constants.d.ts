...
export declare enum ACCT_ACTIVITY {
    subscriptionKey = 0,
    accountNumber = 1,
    messageType = 2,
    messageData = 3
}
export declare enum CHART_EQUITY {
    key = 0,
    openPrice = 1,
    highPrice = 2,
    lowPrice = 3,
...
export declare enum CHART_FUTURES {
    key = 0,
    chartTime = 1,
    openPrice = 2,
    highPrice = 3,
...
export declare enum CHART_OPTIONS {
    key = 0,
    chartTime = 1,
    openPrice = 2,
    highPrice = 3,
...
export declare enum NEWS_HEADLINE {
    symbol = 0,
    errorCode = 1,
    storyDatetime = 2,
    headlineId = 3,
...
export declare enum LEVEL_ONE_EQUITY {
    symbol = 0,
    bidPrice = 1,
    askPrice = 2,
    lastPrice = 3,
...
export declare enum LEVEL_ONE_FUTURES {
    symbol = 0,
    bidPrice = 1,
    askPrice = 2,
    lastPrice = 3,
...
export declare enum LEVEL_ONE_OPTION {
    symbol = 0,
    description = 1,
    bidPrice = 2,
    askPrice = 3,
...
export declare enum LISTED_BOOK {
    symbol = 0,
    bookTime = 1,
    bids = 2,
    asks = 3
}
export declare enum NASDAQ_BOOK {
    symbol = 0,
    bookTime = 1,
    bids = 2,
    asks = 3
}
export declare enum OPTIONS_BOOK {
    symbol = 0,
    bookTime = 1,
    bids = 2,
    asks = 3
}
export declare enum BID_FIELDS {
    price = 0,
    totalVolume = 1,
    numBids = 2,
    bids = 3
}
export declare enum ASK_FIELDS {
    price = 0,
    totalVolume = 1,
    numAsks = 2,
    asks = 3
}
export declare enum ORDER_BOOK_EXCHANGE_FIELDS {
    exchange = 0,
    volume = 1,
    sequence = 2
}
export declare const FIELDS: Readonly<{
    QOS: typeof QOS;
