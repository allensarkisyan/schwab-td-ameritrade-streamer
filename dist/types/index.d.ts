...
declare module "@allensarkisyan/schwab-td-ameritrade-streamer/td-stream-event-processor" {
    ...
    import { TDAmeritradeStreamServiceResponse, TDAmeritradeStreamDataResponse } from "@allensarkisyan/schwab-td-ameritrade-streamer/@types";
    /**
...
declare module "@allensarkisyan/schwab-td-ameritrade-streamer" {
    import { TDAmeritradeStreamerConnectionOptions, TDAmeritradeStreamerCommand, TickerSymbolKeys } from "@allensarkisyan/schwab-td-ameritrade-streamer/@types";
    /**
     * TD Ameritrade Stream Connection Options
