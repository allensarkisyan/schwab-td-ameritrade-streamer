declare module "td-constants" {
    ...
    export const FIELDS: Readonly<{
        ...
        ACCT_ACTIVITY: Readonly<{
            subscriptionKey: 0;
            accountNumber: 1;
            messageType: 2;
            messageData: 3;
        }>;
        CHART_EQUITY: Readonly<{
            key: 0;
            openPrice: 1;
            highPrice: 2;
            lowPrice: 3;
        ...
        LISTED_BOOK: Readonly<{
            symbol: 0;
            bookTime: 1;
            bids: 2;
            asks: 3;
        }>;
        NASDAQ_BOOK: Readonly<{
            symbol: 0;
            bookTime: 1;
            bids: 2;
            asks: 3;
        }>;
        OPTIONS_BOOK: Readonly<{
            symbol: 0;
            bookTime: 1;
            bids: 2;
            asks: 3;
        ...
        ORDER_BOOK_EXCHANGE_FIELDS: Readonly<{
            exchange: 0;
            volume: 1;
            sequence: 2;
        }>;
